...
WebSocketChannel? channel; //as WebSocketChannel;
// ignore: cast_from_null_always_fails, non_constant_identifier_names
locate_dart.LocationData? current_position; //as locate_dart.LocationData;
                    ...
                    InAppWebView(
                        ...
                        onLoadHttpError:
                            (controller, url, statusCode, description) => {
                                  debugPrint("Load Http error : ${statusCode},URL : ${url.toString()}"),
                                  setState(
                                    () => showErrorPage = false,
                                  )
                                },
